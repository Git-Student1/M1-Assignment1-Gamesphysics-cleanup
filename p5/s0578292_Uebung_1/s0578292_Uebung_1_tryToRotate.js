...
function setup() {
  ...
  // push();
  //     fill(0,0,255)
  //     translate(seeSawSupport1CenterX,seesawStartY)
  //     rectMode(CENTER)
  //     rotate(radians(-20))
      
      
  //     //rect(0,0,1000,1000)
  //     rect(0,0,seesawWidth,  seesawHeight );
  //     rectMode(CORNER)
  // pop();
  ...
  push();
      ...
      //rect(0,0,1000,1000)
      rect(0,0,seesawWidth,  seesawHeight );
      drawTriangle(-0.10*m, -seesawHeight/2, seesawBallStopWidth, seesawBallStopHeight);
      ellipse(-0.115*m, - throwBallDiameter, throwBallDiameter,throwBallDiameter );
      rectMode(CORNER)
  pop();
